...
impl Lexicon {
    ...
    pub fn apply_curated_signatures(&mut self) {
        // Dimensioni (ordine I Ching canonico):
        // [Agency, Permanenza, Intensita, Tempo, Confine, Complessita, Definizione, Valenza]
        //   0        1           2          3      4         5            6            7
        // (☰ Cielo, ☷ Terra, ☳ Tuono, ☵ Acqua, ☶ Montagna, ☴ Vento, ☲ Fuoco, ☱ Lago)
        let curated: &[(&str, [f64; 8])] = &[
            // ── PRONOMI ──────────────────────────────────────────────────────
            ("io",         [0.80, 0.75, 0.65, 0.40, 0.95, 0.50, 0.90, 0.50]),
            ("me",         [0.55, 0.65, 0.55, 0.40, 0.85, 0.45, 0.80, 0.50]),
            ("mio",        [0.65, 0.80, 0.45, 0.30, 0.90, 0.35, 0.85, 0.60]),
            ("mia",        [0.65, 0.80, 0.45, 0.30, 0.90, 0.35, 0.85, 0.60]),
            ("miei",       [0.63, 0.80, 0.42, 0.30, 0.88, 0.35, 0.83, 0.60]),
            ("mie",        [0.63, 0.80, 0.42, 0.30, 0.88, 0.35, 0.83, 0.60]),
            ("tu",         [0.50, 0.45, 0.55, 0.50, 0.10, 0.40, 0.65, 0.70]),
            ("te",         [0.35, 0.40, 0.50, 0.50, 0.15, 0.35, 0.60, 0.65]),
            ("tuo",        [0.40, 0.50, 0.42, 0.40, 0.18, 0.32, 0.65, 0.62]),
            ("tua",        [0.40, 0.50, 0.42, 0.40, 0.18, 0.32, 0.65, 0.62]),
            ("noi",        [0.65, 0.60, 0.60, 0.45, 0.35, 0.65, 0.55, 0.75]),
            ("lui",        [0.55, 0.50, 0.45, 0.50, 0.50, 0.45, 0.60, 0.50]),
            ("lei",        [0.52, 0.50, 0.48, 0.50, 0.48, 0.45, 0.62, 0.52]),
            ("loro",       [0.50, 0.50, 0.42, 0.45, 0.30, 0.55, 0.55, 0.48]),
            ("voi",        [0.52, 0.48, 0.48, 0.48, 0.25, 0.55, 0.58, 0.55]),
            ("se",         [0.55, 0.65, 0.45, 0.40, 0.80, 0.45, 0.75, 0.50]),
            // ── VERBI ESISTENZIALI ────────────────────────────────────────────
            ("essere",     [0.10, 0.90, 0.15, 0.30, 0.50, 0.55, 0.70, 0.50]),
            ("avere",      [0.70, 0.60, 0.40, 0.35, 0.70, 0.40, 0.65, 0.55]),
            ("fare",       [0.95, 0.35, 0.75, 0.70, 0.45, 0.45, 0.65, 0.50]),
            ("stare",      [0.15, 0.75, 0.20, 0.35, 0.55, 0.35, 0.55, 0.50]),
            ("vivere",     [0.55, 0.60, 0.55, 0.50, 0.45, 0.65, 0.55, 0.70]),
            ("morire",     [0.10, 0.95, 0.70, 0.10, 0.85, 0.45, 0.90, 0.10]),
            ("diventare",  [0.60, 0.40, 0.55, 0.70, 0.30, 0.65, 0.45, 0.60]),
            ("restare",    [0.25, 0.80, 0.20, 0.25, 0.65, 0.30, 0.65, 0.55]),
            ("esistere",   [0.15, 0.85, 0.30, 0.35, 0.50, 0.60, 0.65, 0.60]),
            // ── VERBI MODALI ──────────────────────────────────────────────────
            ("volere",     [0.85, 0.50, 0.80, 0.75, 0.70, 0.45, 0.55, 0.70]),
            ("potere",     [0.75, 0.40, 0.50, 0.60, 0.40, 0.50, 0.45, 0.60]),
            ("dovere",     [0.45, 0.70, 0.65, 0.55, 0.75, 0.40, 0.85, 0.35]),
            ("sapere",     [0.55, 0.80, 0.35, 0.30, 0.75, 0.60, 0.90, 0.65]),
            // ── VERBI COGNITIVI ───────────────────────────────────────────────
            ("pensare",    [0.65, 0.45, 0.40, 0.50, 0.85, 0.80, 0.60, 0.50]),
            ("sentire",    [0.20, 0.25, 0.70, 0.50, 0.20, 0.45, 0.45, 0.55]),
            ("capire",     [0.65, 0.60, 0.50, 0.45, 0.60, 0.70, 0.75, 0.70]),
            ("credere",    [0.50, 0.65, 0.45, 0.40, 0.65, 0.55, 0.50, 0.55]),
            ("ricordare",  [0.55, 0.75, 0.50, 0.15, 0.70, 0.55, 0.65, 0.55]),
            ("dimenticare",[0.25, 0.15, 0.45, 0.20, 0.40, 0.50, 0.45, 0.30]),
            ("immaginare", [0.65, 0.30, 0.55, 0.75, 0.15, 0.80, 0.30, 0.65]),
            ("sognare",    [0.45, 0.30, 0.55, 0.70, 0.10, 0.80, 0.25, 0.70]),
            ("conoscere",  [0.55, 0.75, 0.35, 0.35, 0.70, 0.65, 0.80, 0.60]),
            ("decidere",   [0.80, 0.55, 0.55, 0.60, 0.80, 0.50, 0.80, 0.55]),
            ("cercare",    [0.75, 0.30, 0.60, 0.70, 0.20, 0.55, 0.35, 0.55]),
            ("trovare",    [0.70, 0.55, 0.55, 0.55, 0.60, 0.50, 0.65, 0.70]),
            // ── VERBI COMUNICATIVI ────────────────────────────────────────────
            ("dire",       [0.80, 0.40, 0.60, 0.55, 0.30, 0.50, 0.70, 0.55]),
            ("parlare",    [0.75, 0.35, 0.65, 0.55, 0.25, 0.55, 0.60, 0.60]),
            ("chiedere",   [0.75, 0.25, 0.55, 0.60, 0.20, 0.50, 0.45, 0.60]),
            ("rispondere", [0.70, 0.40, 0.55, 0.50, 0.35, 0.45, 0.70, 0.60]),
            ("ascoltare",  [0.50, 0.30, 0.55, 0.50, 0.20, 0.45, 0.60, 0.60]),
            ("guardare",   [0.55, 0.30, 0.55, 0.50, 0.30, 0.40, 0.65, 0.55]),
            // ── VERBI DI MOTO ─────────────────────────────────────────────────
            ("andare",     [0.90, 0.20, 0.70, 0.85, 0.15, 0.35, 0.55, 0.55]),
            ("venire",     [0.80, 0.25, 0.65, 0.70, 0.25, 0.35, 0.55, 0.65]),
            ("dare",       [0.80, 0.45, 0.60, 0.55, 0.25, 0.40, 0.65, 0.70]),
            ("prendere",   [0.85, 0.55, 0.65, 0.55, 0.70, 0.40, 0.65, 0.55]),
            ("amare",      [0.65, 0.75, 0.70, 0.40, 0.20, 0.65, 0.50, 0.92]),
            ("odiare",     [0.65, 0.55, 0.90, 0.45, 0.75, 0.40, 0.65, 0.05]),
            // ── EMOZIONI ANCHOR ───────────────────────────────────────────────
            ("gioia",      [0.55, 0.30, 0.80, 0.60, 0.25, 0.35, 0.55, 0.95]),
            ("tristezza",  [0.15, 0.55, 0.65, 0.25, 0.65, 0.45, 0.55, 0.10]),
            ("paura",      [0.10, 0.50, 0.90, 0.65, 0.80, 0.55, 0.40, 0.05]),
            ("rabbia",     [0.75, 0.40, 0.95, 0.55, 0.75, 0.40, 0.65, 0.15]),
            ("amore",      [0.60, 0.80, 0.75, 0.40, 0.15, 0.70, 0.50, 0.95]),
            ("dolore",     [0.10, 0.55, 0.90, 0.35, 0.70, 0.40, 0.70, 0.05]),
            ("calma",      [0.30, 0.70, 0.10, 0.35, 0.50, 0.30, 0.65, 0.75]),
            ("pace",       [0.20, 0.75, 0.05, 0.30, 0.30, 0.30, 0.60, 0.85]),
            ("speranza",   [0.55, 0.40, 0.50, 0.90, 0.35, 0.45, 0.35, 0.80]),
            ("nostalgia",  [0.15, 0.70, 0.60, 0.05, 0.65, 0.55, 0.55, 0.45]),
            ("piacere",    [0.55, 0.25, 0.70, 0.50, 0.30, 0.40, 0.50, 0.90]),
            ("curiosita",  [0.70, 0.35, 0.55, 0.65, 0.15, 0.80, 0.25, 0.70]),
            ("curiosità",  [0.70, 0.35, 0.55, 0.65, 0.15, 0.80, 0.25, 0.70]),
            ("sorpresa",   [0.20, 0.15, 0.85, 0.55, 0.20, 0.50, 0.30, 0.65]),
            ("solitudine", [0.20, 0.65, 0.55, 0.35, 0.95, 0.30, 0.75, 0.25]),
            ("malinconia", [0.15, 0.65, 0.55, 0.15, 0.70, 0.55, 0.55, 0.35]),
            ("angoscia",   [0.10, 0.60, 0.88, 0.55, 0.85, 0.55, 0.55, 0.05]),
            ("serenita",   [0.28, 0.75, 0.08, 0.32, 0.45, 0.30, 0.65, 0.82]),
            ("serenità",   [0.28, 0.75, 0.08, 0.32, 0.45, 0.30, 0.65, 0.82]),
            ("gioia",      [0.55, 0.30, 0.80, 0.60, 0.25, 0.35, 0.55, 0.95]),
            ("entusiasmo", [0.80, 0.35, 0.90, 0.70, 0.25, 0.45, 0.55, 0.85]),
            ("paura",      [0.10, 0.50, 0.90, 0.65, 0.80, 0.55, 0.40, 0.05]),
            // ── CONCETTI FONDAMENTALI ─────────────────────────────────────────
            ("vita",       [0.60, 0.70, 0.65, 0.50, 0.40, 0.80, 0.50, 0.75]),
            ("morte",      [0.05, 0.95, 0.70, 0.05, 0.90, 0.35, 0.95, 0.10]),
            ("tempo",      [0.05, 0.90, 0.40, 0.95, 0.10, 0.70, 0.60, 0.50]),
            ("spazio",     [0.05, 0.95, 0.25, 0.10, 0.05, 0.55, 0.55, 0.50]),
            ("mondo",      [0.10, 0.80, 0.50, 0.50, 0.10, 0.90, 0.45, 0.55]),
            ("cosa",       [0.25, 0.50, 0.30, 0.40, 0.50, 0.40, 0.40, 0.50]),
            ("forma",      [0.20, 0.70, 0.30, 0.25, 0.80, 0.55, 0.85, 0.55]),
            ("senso",      [0.50, 0.65, 0.50, 0.45, 0.55, 0.80, 0.60, 0.70]),
            ("voce",       [0.70, 0.30, 0.65, 0.55, 0.25, 0.45, 0.65, 0.60]),
            ("silenzio",   [0.10, 0.65, 0.05, 0.30, 0.40, 0.35, 0.75, 0.55]),
            ("parola",     [0.60, 0.60, 0.45, 0.45, 0.65, 0.50, 0.80, 0.65]),
            ("luce",       [0.20, 0.45, 0.75, 0.50, 0.10, 0.35, 0.70, 0.80]),
            ("buio",       [0.10, 0.55, 0.50, 0.30, 0.30, 0.50, 0.30, 0.25]),
            ("oscurita",   [0.08, 0.60, 0.45, 0.28, 0.35, 0.50, 0.35, 0.20]),
            ("oscurità",   [0.08, 0.60, 0.45, 0.28, 0.35, 0.50, 0.35, 0.20]),
            ("bene",       [0.55, 0.70, 0.50, 0.40, 0.45, 0.50, 0.65, 0.90]),
            ("male",       [0.50, 0.60, 0.65, 0.40, 0.55, 0.50, 0.65, 0.05]),
            ("vero",       [0.30, 0.85, 0.45, 0.30, 0.70, 0.50, 0.95, 0.75]),
            ("falso",      [0.45, 0.55, 0.50, 0.35, 0.60, 0.45, 0.70, 0.15]),
            ("reale",      [0.15, 0.80, 0.50, 0.35, 0.75, 0.45, 0.90, 0.60]),
            ("inizio",     [0.50, 0.65, 0.60, 0.20, 0.20, 0.40, 0.70, 0.65]),
            ("fine",       [0.20, 0.90, 0.55, 0.05, 0.90, 0.35, 0.90, 0.35]),
            ("cambiamento",[0.65, 0.25, 0.65, 0.70, 0.25, 0.70, 0.45, 0.55]),
            ("nuovo",      [0.55, 0.25, 0.65, 0.80, 0.20, 0.50, 0.40, 0.70]),
            ("nuova",      [0.55, 0.25, 0.65, 0.80, 0.20, 0.50, 0.40, 0.70]),
            ("vuoto",      [0.05, 0.60, 0.15, 0.30, 0.20, 0.30, 0.65, 0.25]),
            ("pieno",      [0.30, 0.65, 0.60, 0.35, 0.65, 0.45, 0.70, 0.70]),
            ("altro",      [0.50, 0.55, 0.45, 0.45, 0.15, 0.60, 0.50, 0.55]),
            ("altra",      [0.50, 0.55, 0.45, 0.45, 0.15, 0.60, 0.50, 0.55]),
            ("insieme",    [0.65, 0.60, 0.60, 0.45, 0.20, 0.55, 0.60, 0.75]),
            ("solo",       [0.35, 0.60, 0.55, 0.35, 0.95, 0.25, 0.80, 0.30]),
            ("sola",       [0.35, 0.60, 0.55, 0.35, 0.95, 0.25, 0.80, 0.30]),
            ("corpo",      [0.55, 0.70, 0.60, 0.40, 0.80, 0.60, 0.75, 0.55]),
            ("mente",      [0.70, 0.65, 0.50, 0.45, 0.75, 0.90, 0.65, 0.60]),
            ("cuore",      [0.60, 0.70, 0.75, 0.40, 0.55, 0.65, 0.60, 0.75]),
            ("anima",      [0.45, 0.80, 0.55, 0.40, 0.30, 0.80, 0.40, 0.70]),
            ("sogno",      [0.45, 0.35, 0.60, 0.70, 0.20, 0.75, 0.25, 0.70]),
            ("energia",    [0.80, 0.50, 0.90, 0.60, 0.25, 0.45, 0.50, 0.70]),
            ("niente",     [0.05, 0.85, 0.05, 0.30, 0.10, 0.15, 0.80, 0.20]),
            ("nulla",      [0.05, 0.87, 0.05, 0.28, 0.10, 0.12, 0.82, 0.18]),
            ("tutto",      [0.25, 0.80, 0.70, 0.40, 0.05, 0.90, 0.75, 0.65]),
            ("presente",   [0.40, 0.55, 0.60, 0.50, 0.50, 0.45, 0.75, 0.55]),
            ("passato",    [0.10, 0.85, 0.40, 0.05, 0.70, 0.55, 0.75, 0.45]),
            ("futuro",     [0.65, 0.20, 0.50, 0.95, 0.20, 0.65, 0.30, 0.60]),
            // ── QUALITA FONDAMENTALI ──────────────────────────────────────────
            ("bello",      [0.35, 0.45, 0.70, 0.45, 0.40, 0.55, 0.55, 0.90]),
            ("bella",      [0.35, 0.45, 0.70, 0.45, 0.40, 0.55, 0.55, 0.90]),
            ("brutto",     [0.30, 0.40, 0.60, 0.40, 0.55, 0.40, 0.55, 0.10]),
            ("brutta",     [0.30, 0.40, 0.60, 0.40, 0.55, 0.40, 0.55, 0.10]),
            ("grande",     [0.35, 0.75, 0.65, 0.40, 0.25, 0.70, 0.70, 0.65]),
            ("piccolo",    [0.30, 0.55, 0.30, 0.35, 0.75, 0.30, 0.65, 0.55]),
            ("piccola",    [0.30, 0.55, 0.30, 0.35, 0.75, 0.30, 0.65, 0.55]),
            ("forte",      [0.85, 0.75, 0.80, 0.50, 0.80, 0.40, 0.75, 0.65]),
            ("debole",     [0.20, 0.35, 0.30, 0.35, 0.35, 0.40, 0.60, 0.35]),
            ("lontano",    [0.25, 0.60, 0.35, 0.40, 0.05, 0.35, 0.70, 0.40]),
            ("lontana",    [0.25, 0.60, 0.35, 0.40, 0.05, 0.35, 0.70, 0.40]),
            ("vicino",     [0.40, 0.55, 0.50, 0.45, 0.60, 0.30, 0.70, 0.65]),
            ("vicina",     [0.40, 0.55, 0.50, 0.45, 0.60, 0.30, 0.70, 0.65]),
            ("presto",     [0.60, 0.25, 0.65, 0.80, 0.45, 0.25, 0.65, 0.60]),
            ("tardi",      [0.35, 0.45, 0.40, 0.20, 0.50, 0.25, 0.65, 0.40]),
        ];
    ...
    fn seed_cardinal_vocabulary(&mut self) {
        // Ordine I Ching canonico: [Agency, Permanenza, Intensita, Tempo, Confine, Complessita, Definizione, Valenza]

        // SPAZIO (id=36, ☶☶ Confine=0.30): percezione dello spazio
        // [Agency=0.1, Perm=0.8, Intens=0.3, Tempo=0.2, Confine=0.2, Compl=0.3, Defin=0.7, Val=0.5]
        ...
        // [Agency=0.2, Perm=0.3, Intens=0.4, Tempo=0.9, Confine=0.3, Compl=0.2, Defin=0.5, Val=0.5]
        let base = PrimitiveCore::new([0.2, 0.3, 0.4, 0.9, 0.3, 0.2, 0.5, 0.5]);
        ...
        // [Agency=0.7, Perm=0.5, Intens=0.5, Tempo=0.4, Confine=0.9, Compl=0.5, Defin=0.6, Val=0.5]
        let base = PrimitiveCore::new([0.7, 0.5, 0.5, 0.4, 0.9, 0.5, 0.6, 0.5]);
        ...
        // [Agency=0.5, Perm=0.5, Intens=0.5, Tempo=0.4, Confine=0.5, Compl=0.5, Defin=0.5, Val=0.6]
        let base = PrimitiveCore::new([0.5, 0.5, 0.5, 0.4, 0.5, 0.5, 0.5, 0.6]);
        ...
        // [Agency=0.5, Perm=0.2, Intens=0.4, Tempo=0.5, Confine=0.3, Compl=0.5, Defin=0.2, Val=0.5]
        let base = PrimitiveCore::new([0.5, 0.2, 0.4, 0.5, 0.3, 0.5, 0.2, 0.5]);
        ...
        // [Agency=0.2, Perm=0.8, Intens=0.5, Tempo=0.3, Confine=0.5, Compl=0.3, Defin=0.9, Val=0.3]
        let base = PrimitiveCore::new([0.2, 0.8, 0.5, 0.3, 0.5, 0.3, 0.9, 0.3]);
    ...
    ///
    /// Le firme sono in ordine I Ching canonico:
    ///   [Agency, Permanenza, Intensita, Tempo, Confine, Complessita, Definizione, Valenza]
    ///     0        1           2          3      4         5            6            7
    ///   (☰ Cielo, ☷ Terra, ☳ Tuono, ☵ Acqua, ☶ Montagna, ☴ Vento, ☲ Fuoco, ☱ Lago)
    fn seed_bootstrap_vocabulary(&mut self) {
        ...
        // RISPOSTE
        // [0.5, 0.3, 0.3, 0.5, 0.5, 0.1, 0.8, 0.5]
        let base = PrimitiveCore::new([0.5, 0.3, 0.3, 0.5, 0.5, 0.1, 0.8, 0.5]);
        ...
        // DOMANDE
        // [0.6, 0.2, 0.5, 0.5, 0.3, 0.4, 0.3, 0.5]
        let base = PrimitiveCore::new([0.6, 0.2, 0.5, 0.5, 0.3, 0.4, 0.3, 0.5]);
        ...
        // ESPRESSIONI
        // [0.6, 0.3, 0.5, 0.5, 0.5, 0.3, 0.5, 0.7]
        let base = PrimitiveCore::new([0.6, 0.3, 0.5, 0.5, 0.5, 0.3, 0.5, 0.7]);
        ...
        // MOTO
        // [0.8, 0.2, 0.6, 0.8, 0.2, 0.3, 0.5, 0.5]
        let base = PrimitiveCore::new([0.8, 0.2, 0.6, 0.8, 0.2, 0.3, 0.5, 0.5]);
        ...
        // MANIPOLAZIONE
        // [0.9, 0.3, 0.6, 0.7, 0.5, 0.4, 0.7, 0.5]
        let base = PrimitiveCore::new([0.9, 0.3, 0.6, 0.7, 0.5, 0.4, 0.7, 0.5]);
        ...
        // PERCEZIONE
        // [0.3, 0.3, 0.5, 0.5, 0.7, 0.3, 0.6, 0.5]
        let base = PrimitiveCore::new([0.3, 0.3, 0.5, 0.5, 0.7, 0.3, 0.6, 0.5]);
        ...
        // COMUNICAZ_VERB
        // [0.8, 0.3, 0.6, 0.6, 0.5, 0.5, 0.6, 0.6]
        let base = PrimitiveCore::new([0.8, 0.3, 0.6, 0.6, 0.5, 0.5, 0.6, 0.6]);
        ...
        // PENSIERO_VERB
        // [0.6, 0.4, 0.4, 0.4, 0.9, 0.7, 0.7, 0.5]
        let base = PrimitiveCore::new([0.6, 0.4, 0.4, 0.4, 0.9, 0.7, 0.7, 0.5]);
        ...
        // STATO_VERB
        // [0.1, 0.8, 0.2, 0.2, 0.5, 0.2, 0.5, 0.5]
        let base = PrimitiveCore::new([0.1, 0.8, 0.2, 0.2, 0.5, 0.2, 0.5, 0.5]);
        ...
        // EMOZIONE_VERB
        // [0.4, 0.4, 0.8, 0.5, 0.8, 0.5, 0.4, 0.6]
        let base = PrimitiveCore::new([0.4, 0.4, 0.8, 0.5, 0.8, 0.5, 0.4, 0.6]);
        ...
        // CREAZIONE_VERB
        // [0.9, 0.5, 0.7, 0.7, 0.4, 0.7, 0.5, 0.7]
        let base = PrimitiveCore::new([0.9, 0.5, 0.7, 0.7, 0.4, 0.7, 0.5, 0.7]);
        ...
        // ELEMENTI
        // [0.3, 0.9, 0.7, 0.5, 0.1, 0.3, 0.5, 0.5]
        let base = PrimitiveCore::new([0.3, 0.9, 0.7, 0.5, 0.1, 0.3, 0.5, 0.5]);
        ...
        // FENOMENI
        // [0.5, 0.2, 0.7, 0.8, 0.1, 0.5, 0.4, 0.4]
        let base = PrimitiveCore::new([0.5, 0.2, 0.7, 0.8, 0.1, 0.5, 0.4, 0.4]);
        ...
        // PAESAGGI
        // [0.1, 0.9, 0.4, 0.2, 0.1, 0.5, 0.7, 0.6]
        let base = PrimitiveCore::new([0.1, 0.9, 0.4, 0.2, 0.1, 0.5, 0.7, 0.6]);
        ...
        // VITA_VEGETALE
        // [0.2, 0.6, 0.3, 0.4, 0.2, 0.4, 0.6, 0.6]
        let base = PrimitiveCore::new([0.2, 0.6, 0.3, 0.4, 0.2, 0.4, 0.6, 0.6]);
        ...
        // PARTI_CORPO
        // [0.3, 0.7, 0.4, 0.3, 0.8, 0.3, 0.8, 0.5]
        let base = PrimitiveCore::new([0.3, 0.7, 0.4, 0.3, 0.8, 0.3, 0.8, 0.5]);
        ...
        // SENSAZIONI
        // [0.1, 0.2, 0.7, 0.5, 0.9, 0.2, 0.4, 0.4]
        let base = PrimitiveCore::new([0.1, 0.2, 0.7, 0.5, 0.9, 0.2, 0.4, 0.4]);
        ...
        // EMOZIONI_POS
        // [0.3, 0.4, 0.7, 0.5, 0.8, 0.4, 0.4, 0.9]
        let base = PrimitiveCore::new([0.3, 0.4, 0.7, 0.5, 0.8, 0.4, 0.4, 0.9]);
        ...
        // EMOZIONI_NEG
        // [0.2, 0.4, 0.7, 0.5, 0.8, 0.4, 0.4, 0.1]
        let base = PrimitiveCore::new([0.2, 0.4, 0.7, 0.5, 0.8, 0.4, 0.4, 0.1]);
        ...
        // EMOZIONI_MIX
        // [0.3, 0.3, 0.6, 0.5, 0.8, 0.5, 0.3, 0.5]
        let base = PrimitiveCore::new([0.3, 0.3, 0.6, 0.5, 0.8, 0.5, 0.3, 0.5]);
        ...
        // [0.2, 0.6, 0.25, 0.5, 0.7, 0.3, 0.3, 0.85]
        let base = PrimitiveCore::new([0.2, 0.6, 0.25, 0.5, 0.7, 0.3, 0.3, 0.85]);
        ...
        // [0.3, 0.5, 0.5, 0.5, 0.8, 0.5, 0.5, 0.7]
        let base = PrimitiveCore::new([0.3, 0.5, 0.5, 0.5, 0.8, 0.5, 0.5, 0.7]);
        ...
        // CONCETTI
        // [0.3, 0.7, 0.4, 0.3, 0.7, 0.8, 0.6, 0.5]
        let base = PrimitiveCore::new([0.3, 0.7, 0.4, 0.3, 0.7, 0.8, 0.6, 0.5]);
        ...
        // CONOSCENZA
        // [0.5, 0.6, 0.4, 0.3, 0.8, 0.7, 0.8, 0.6]
        let base = PrimitiveCore::new([0.5, 0.6, 0.4, 0.3, 0.8, 0.7, 0.8, 0.6]);
        ...
        // MOMENTI
        // [0.3, 0.1, 0.4, 0.7, 0.3, 0.2, 0.5, 0.5]
        let base = PrimitiveCore::new([0.3, 0.1, 0.4, 0.7, 0.3, 0.2, 0.5, 0.5]);
        ...
        // DURATE
        // [0.2, 0.7, 0.3, 0.6, 0.3, 0.3, 0.5, 0.5]
        let base = PrimitiveCore::new([0.2, 0.7, 0.3, 0.6, 0.3, 0.3, 0.5, 0.5]);
        ...
        // LUOGHI
        // [0.1, 0.8, 0.3, 0.2, 0.3, 0.4, 0.7, 0.5]
        let base = PrimitiveCore::new([0.1, 0.8, 0.3, 0.2, 0.3, 0.4, 0.7, 0.5]);
        ...
        // STRUTTURE
        // [0.2, 0.8, 0.3, 0.2, 0.6, 0.5, 0.8, 0.5]
        let base = PrimitiveCore::new([0.2, 0.8, 0.3, 0.2, 0.6, 0.5, 0.8, 0.5]);
        ...
        // PERSONE
        // [0.5, 0.6, 0.4, 0.4, 0.6, 0.6, 0.6, 0.6]
        let base = PrimitiveCore::new([0.5, 0.6, 0.4, 0.4, 0.6, 0.6, 0.6, 0.6]);
        ...
        // LEGAMI
        // [0.5, 0.6, 0.6, 0.5, 0.5, 0.6, 0.4, 0.7]
        let base = PrimitiveCore::new([0.5, 0.6, 0.6, 0.5, 0.5, 0.6, 0.4, 0.7]);
        ...
        // DIMENSIONE
        // [0.1, 0.5, 0.5, 0.2, 0.3, 0.3, 0.6, 0.5]
        let base = PrimitiveCore::new([0.1, 0.5, 0.5, 0.2, 0.3, 0.3, 0.6, 0.5]);
        ...
        // INTENSITA_Q
        // [0.2, 0.4, 0.7, 0.3, 0.4, 0.3, 0.6, 0.5]
        let base = PrimitiveCore::new([0.2, 0.4, 0.7, 0.3, 0.4, 0.3, 0.6, 0.5]);
        ...
        // VALORE_Q
        // [0.2, 0.5, 0.4, 0.3, 0.5, 0.3, 0.6, 0.6]
        let base = PrimitiveCore::new([0.2, 0.5, 0.4, 0.3, 0.5, 0.3, 0.6, 0.6]);
        ...
        // TEMPO_Q
        // [0.3, 0.3, 0.5, 0.8, 0.3, 0.2, 0.5, 0.5]
        let base = PrimitiveCore::new([0.3, 0.3, 0.5, 0.8, 0.3, 0.2, 0.5, 0.5]);
        ...
        // POSSIBILITA
        // [0.4, 0.2, 0.4, 0.4, 0.3, 0.5, 0.2, 0.5]
        let base = PrimitiveCore::new([0.4, 0.2, 0.4, 0.4, 0.3, 0.5, 0.2, 0.5]);
        ...
        // CONFINI
        // [0.3, 0.7, 0.5, 0.3, 0.5, 0.4, 0.9, 0.4]
        let base = PrimitiveCore::new([0.3, 0.7, 0.5, 0.3, 0.5, 0.4, 0.9, 0.4]);
        ...
        // CONNETTIVI
        // [0.3, 0.3, 0.3, 0.4, 0.5, 0.4, 0.5, 0.5]
        let base = PrimitiveCore::new([0.3, 0.3, 0.3, 0.4, 0.5, 0.4, 0.5, 0.5]);
